...
== Upgrade Notice == 
= 4.0.23 =
When the xml feed does not have an image it will show a standard no image
= 4.0.22 = 
This fixes when you remove feed all items that where selected in other feeds dissapeared